...
export function CheckCircleIcon(props: Props) {
  ...
  return (
    <svg tabIndex={0} aria-label="check-circle-icon" {...omit(props, ['color'])} width={props.width || 42} height={props.height || 42} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
