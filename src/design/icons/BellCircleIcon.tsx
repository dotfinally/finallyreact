...
export function BellCircleIcon(props: Props) {
  const strokeColor = props.color ? `var(--${props.color})` : 'black';

  return (
    <svg tabIndex={0} aria-label="bell-circle-icon" {...omit(props, ['color'])} width={props.width || 42} height={props.height || 42} viewBox="0 0 42 42" xmlns="http://www.w3.org/2000/svg">
      <circle cx="21" cy="21" r="20" stroke={strokeColor} strokeWidth="2" fill="none" />
      <svg x="4.5" y="4.5" fill={strokeColor} width="33" height="33" viewBox="0 0 33 33">
